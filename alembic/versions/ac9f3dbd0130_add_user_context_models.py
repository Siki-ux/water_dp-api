...
Revision ID: ac9f3dbd0130
Revises:
Create Date: 2026-01-07 17:28:22.497547
...
def upgrade() -> None:
    ...
    # op.create_table('geo_layers') and geo_features skipped as they exist
    op.create_table(
        "projects",
    ...
    # op.create_table('geo_features') skipped
    op.create_table(
        "project_members",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("project_id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("project_id", "sensor_id"),
    )
    pass
