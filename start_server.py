...
def start_server():
    ...
    print(f"Swagger UI will be available at: http://localhost:8000{settings.api_prefix}/docs")
    print(f"ReDoc will be available at: http://localhost:8000{settings.api_prefix}/redoc")
