...
from sqlalchemy import Column, String, Float, DateTime, Text, ForeignKey, Index, Integer
...
class WaterDataPoint(Base, BaseModel):
    ...
    parameter = Column(String(50), nullable=False, index=True)  # water_level, flow_rate, etc.
